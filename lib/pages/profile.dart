...
class _ProfilePageState extends State<ProfilePage> {
  ...
  late CustomerIdxGetRes customerIdxGetRes;
  ...
  Future<void> loadDataAsync() async {
    ...
    log(res.body);
    customerIdxGetRes = CustomerIdxGetResFromJson(res.body);
    nameCtl.text = customerIdxGetRes.fullname;
    phoneCtl.text = customerIdxGetRes.phone;
    emailCtl.text = customerIdxGetRes.email;
    imageCtl.text = customerIdxGetRes.image;
  }
}
